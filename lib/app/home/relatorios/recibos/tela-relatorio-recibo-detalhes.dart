...
class DetalhesRelatorioRecibo extends StatefulWidget {
  final String pdfReciboUrl;

  DetalhesRelatorioRecibo({required this.pdfReciboUrl});

  @override
  _DetalhesRelatorioReciboState createState() => _DetalhesRelatorioReciboState();
}

class _DetalhesRelatorioReciboState extends State<DetalhesRelatorioRecibo> {
  ...
  Future<void> _loadPdf() async {
    try {
      final file = await _downloadFile(widget.pdfReciboUrl, 'recibo_entrega.pdf');
      setState(() {
  ...
  Future<void> _downloadToDevice() async {
    ...
    if (status.isGranted) {
      ...
      final filePath = '${directory?.path}/recibo_entrega.pdf';
